...
/**
 * An activity representing a list of Ideas. This activity
 ...
 * {@link IdeaListFragment} and the item details
 * (if present) is a {@link IdeaDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link IdeaListFragment.Callbacks} interface
...
public class IdeaListActivity extends Activity
    ...
    /**
     * Callback method from {@link IdeaListFragment.Callbacks}
    ...
    public void onItemSelected(int id) {
        if (mTwoPane) {
            ...
            arguments.putInt(IdeaDetailFragment.ARG_ITEM_ID, id);
